...
const NotFound = () => {
  return (
    <div className="h-screen w-screen bg-gray-100 flex items-center font-montserratSans">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          <div className="text-5xl font-dark font-bold" aria-hidden="true">
            404
          </div>
          <h1 className="text-2xl md:text-3xl font-light leading-normal">
